...
<div class="main">
    <div class="title">
        <h3>当前位置：<span>关联币种的会计科目</span></h3>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/subject/inputSubjectDataDrop/todo" class="btn delete">注销</a>
                    </td>
                </tr>
...
<!--------------------------新增录入弹出框-------------------------------------->
<div class="input" id="inputNewBox">
    <form action="/subject/inputSubjectDataNew" method="post">
        <h1>新增会计科目录入<span class="close">×</span></h1>
        <ul>
            <li><span>会计科目名称：</span><input name="subjectName" type="text"/></li>
            <li><span>币种：</span><input name="currency" type="text"/></li>
            <li>
                <span>会计科目级别：</span>
...
<!---------------------------变更录入弹出框-------------------------->
<div class="input" id="inputUpdateBox">
    <form action="/subject/inputSubjectDataUpdate" method="post">
        <h1>变更会计科目<span class="close">×</span></h1>
        <ul>
            <li>
                <span>会计科目余额方向：</span>
                <select name="subjectBalanceDirection">
