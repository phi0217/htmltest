...
<div class="main">
    <div class="title">
        <h3>当前位置：<span>会计科目 > 关联币种的会计科目操作列表</span></h3>
    </div>
    <!--table start-->
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/subject/deleteSubjectDataNew/todo" class="btn delete">删除</a>
                    </td>
                </tr>
                <tr>
                    <td>02</td>
                    ...
                    <td>
                        ...
                        <a href="/subject/deleteSubjectDataUpdate/todo" class="btn delete">删除</a>
                    </td>
                </tr>
                <tr>
                    <td>03</td>
                    ...
                    <td>备注</td>
                    <td>
                        <a href="/subject/deleteSubjectDataDrop/todo" class="btn delete">删除</a>
                    </td>
                </tr>
...
<div class="input" id="modifyNewBox">
    <form action="/subject/modifySubjectDataNew" method="post">
...
<div class="input" id="modifyUpdateBox">
    <form action="/subject/modifySubjectDataUpdate" method="post">
