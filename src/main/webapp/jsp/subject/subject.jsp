            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/subject/inputSubjectDrop/todo" class="btn delete">注销</a>
                    </td>
                </tr>
...
<div class="input" id="inputNewBox">
    <form action="/subject/inputSubjectNew" method="post">
...
<div class="input" id="inputUpdateBox">
    <form action="/subject/inputSubjectUpdate" method="post">
