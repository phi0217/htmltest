...
<div class="main">
	<div class="title">
		<h3>当前位置：<span>会计科目 > 关联币种的新增会计科目复核</span></h3>
	</div>
	<!--table start-->
		...
		<div class="table">
			<table>
				...
				<tr>
					...
					<td>备注</td>
					<td>
						<a href="/subject/auditSubjectDataDrop/todo" class="btn ">复核</a>
					</td>
				</tr>
...
<div class="mask" id="auditNewmask">
	...
	<div class="modal" id="auditNewBox">
		<form action="/subject/auditSubjectDataNew" method="post">
			...
			<div class="modal-body">
				...
				<div class="left">
					...
					<div class="item">
						<input name="currency" type="text" disabled="disabled"/>
						<span>币种：</span>
					</div>
					<div class="item">
...
<div class="mask" id="auditUpdatemask">
	...
	<div class="modal" id="auditUpdate">
		<form action="/subject/auditSubjectDataUpdate" method="post">
			<div class="modal-head">
				<h3>变更会计科目修改</h3>
				<a href="javascript:;" class="close">×</a>
			</div>
